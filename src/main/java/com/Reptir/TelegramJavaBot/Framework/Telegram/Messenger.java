...
public class Messenger {
    ...
    public void sendPhoto(Long chatId, BufferedImage image, String filename) {
        try {
            ...
            tgClient.execute(
                    SendPhoto.builder()
                            .chatId(String.valueOf(chatId))
                            .photo(new InputFile(new ByteArrayInputStream(baos.toByteArray()), filename))
                            .build()
            );

        } catch (Exception e) {
            log.error("Failed BufferedImage photo chatId={}", chatId, e);
        }
    }
    public void sendPhoto(Long chatId, InputStream stream, String filename) {
        try {
            tgClient.execute(
                    SendPhoto.builder()
                            .chatId(String.valueOf(chatId))
            ...
            log.error("Failed InputStream photo chatId={}", chatId, e);
        }
    }
    ...
    public void sendPhoto(Long chatId, File file) {
        try {
            ...
            log.error("Failed to send File photo chatId={}", chatId, e);
        }
    }
